...
\emphbox{$n_\text{syn} = n_N = \frac{f_1}{p}$}

\subsubsection{Drehmoment}
\emphbox{$M_K\sim \frac{U_1}{f_1}$}
\emphbox{\[M_i = -\frac{3p}{\omega_1}\cdot\left[\frac{U_1\cdot U_\text{iP}}{Z_1}\cdot\sin{\left(\vartheta - \varphi_{Z1}\right)} + \frac{{U_\text{iP}}^2}{Z_1}\cdot\sin{\left(\varphi_{Z1}\right)}\right]\]}
Kippmoment:
